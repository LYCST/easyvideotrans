...
def test_specific_english_case():
    """测试特定的英文案例"""
...
if __name__ == "__main__":
    test_english_wrapping()
    test_specific_english_case()
